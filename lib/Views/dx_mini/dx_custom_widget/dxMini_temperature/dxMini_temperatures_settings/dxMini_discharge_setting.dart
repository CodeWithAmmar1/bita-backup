...
class DxMiniDischargeSetting extends StatelessWidget {
  DxMiniDischargeSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 200,
                    initialValue: _mqttController.dischargespDXM.value
                        .toDouble()
                        .clamp(0, 200),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      ...
                      _mqttController.updatedxmDischarge(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.dischargespDXM.value.toStringAsFixed(0)}°C",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dischargespDXM.value > 0) {
                              _mqttController.dischargespDXM.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxmDischarge(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dischargespDXM.value < 200) {
                              _mqttController.dischargespDXM.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxmDischarge(
