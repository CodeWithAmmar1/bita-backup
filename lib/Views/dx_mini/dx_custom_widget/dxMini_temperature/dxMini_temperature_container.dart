...
import 'package:testappbita/Views/dx_mini/dx_custom_widget/dxMini_temperature/dxMini_temperature.dart';
import 'package:testappbita/controller/mqtt_controller/mqtt_controller.dart';
import 'package:testappbita/utils/theme/theme.dart';

// ignore: must_be_immutable
class DxMiniTemperatureContainer extends StatelessWidget {
  final RxBool isReturn = true.obs;
  final String deviceId;
  final MqttController _mqttController = Get.find<MqttController>();
  DxMiniTemperatureContainer({super.key, required this.deviceId});
  @override
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () => Get.to(() => DxMiniTemperature()),
                    child: Icon(
                      Icons.settings,
                      color: Get.isDarkMode ? Colors.white : Colors.black,
                    ...
                    child: Obx(() => GestureDetector(
                          ...
                          child: DXMiniTemperatureWidget(
                            ...
                            temperature: _mqttController
                                    ...
                                    false
                                ? _mqttController.returnDXM.value == 999.9
                                    ? "None"
                                    : _mqttController.returnDXM.value.toString()
                                : "--",
                            getColorLogic: () =>
                    ...
                    child: DXMiniTemperatureWidget(
                      ...
                      temperature:
                          _mqttController.deviceConnections[deviceId] ?? false
                              ? _mqttController.supplyDXM.value == 999.9
                                  ? "None"
                                  : _mqttController.supplyDXM.value.toString()
                              : "--",
                      getColorLogic: () =>
                  ...
                  Expanded(
                    child: DXMiniTemperatureWidget(
                      ...
                      temperature: _mqttController
                                  .deviceConnections[deviceId] ??
                              false
                          ? _mqttController.dischargeDXM.value == 999.9
                              ? "None"
                              : _mqttController.dischargeDXM.value.toString()
                          : "--",
                      getColorLogic: () => _mqttController.dischargeDXM.value >=
