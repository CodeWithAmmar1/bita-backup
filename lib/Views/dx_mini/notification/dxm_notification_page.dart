...
class DxmNotificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            onPressed: () {
              Get.defaultDialog(
                ...
                onConfirm: () {
                  ...
                  _mqttController.clearLastNotifiedValuesDxm(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationController.deviceNotificationMapDxm[deviceid] ?? [];
