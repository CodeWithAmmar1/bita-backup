...
class DrainNoti extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              Get.defaultDialog(
                title: 'delete_all'.tr,
                middleText:
                    'delete_all_notifications_question'.tr,
                textConfirm: 'yes'.tr,
                textCancel: 'no'.tr,
                confirmTextColor: Colors.white,
                onConfirm: () {
                  _notificationController.clearNotifications(deviceid);
                  _mqttController.clearLastNotifiedValuesDm1(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationController.deviceNotificationMapDm[deviceid] ?? [];
