...
class SensorselectiondmB extends StatefulWidget {
  const SensorselectiondmB({super.key});

  @override
  State<SensorselectiondmB> createState() => _SensorselectiondmBState();
}

Timer? publishTimer;

class _SensorselectiondmBState extends State<SensorselectiondmB> {
