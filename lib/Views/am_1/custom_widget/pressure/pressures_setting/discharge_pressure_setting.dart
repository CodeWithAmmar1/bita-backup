...
class DischargePressureSettingAm1 extends StatelessWidget {
  DischargePressureSettingAm1({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 725,
                    initialValue: _mqttController.pressuresp2.value
                        .toDouble()
                        .clamp(0, 725),
                    onChangeStart: (_) =>
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.pressuresp2.value > 0) {
                              _mqttController.pressuresp2.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.pressuresp2.value < 725) {
                              _mqttController.pressuresp2.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.dischargePressure(
