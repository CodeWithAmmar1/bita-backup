...
class SuctionPressureSettingAm1 extends StatelessWidget {
  final MqttController _mqttController = Get.find<MqttController>();

  SuctionPressureSettingAm1({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 300,
                    initialValue: _mqttController.pressuresp1.value
                        .toDouble()
                        .clamp(0, 300),
                    onChangeStart: (_) =>
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.pressuresp1.value > 0) {
                              _mqttController.pressuresp1.value -= 1;
                              publishTimer?.cancel();
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.pressuresp1.value < 300) {
                              _mqttController.pressuresp1.value += 1;
                              publishTimer?.cancel();
                              _mqttController.suctionPressure(
                                  _mqttController.pressuresp1.value
