...
class ReturnAlertSettingAm1 extends StatelessWidget {
  ReturnAlertSettingAm1({super.key});
              ...
              () => Column( 
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 40,
                    initialValue: _mqttController.tempsphigh.value
                        .toDouble()
                        .clamp(0, 40),
                    onChangeStart: (_) {
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.am1ReturnAlert(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.tempsphigh.value.toStringAsFixed(0)}°C",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tempsphigh.value > 0) {
                              _mqttController.tempsphigh.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.am1ReturnAlert(_mqttController
                                    .tempsphigh.value
                                    .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tempsphigh.value < 40) {
                              _mqttController.tempsphigh.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.am1ReturnAlert(_mqttController
