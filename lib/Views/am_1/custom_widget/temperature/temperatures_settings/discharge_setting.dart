...
class DischargeSettingAm1 extends StatelessWidget {
  DischargeSettingAm1({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 200,
                    initialValue: _mqttController.tempsp1.value
                        .toDouble()
                        .clamp(0, 200),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      ...
                      _mqttController.am1DischargeSpAlert(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                      publishTimer = Timer(Duration(seconds: 1), () {
                        _mqttController.buildJsonPayloadAm1();
                        publishTimer = Timer(Duration(seconds: 1), () {
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.tempsp1.value.toStringAsFixed(0)}°C",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tempsp1.value > 0) {
                              _mqttController.tempsp1.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.am1DischargeSpAlert(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tempsp1.value < 200) {
                              _mqttController.tempsp1.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.am1DischargeSpAlert(
