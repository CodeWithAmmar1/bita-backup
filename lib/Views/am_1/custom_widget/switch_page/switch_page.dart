...
class SwitchPageAm1 extends StatelessWidget {
  final String deviceId;
  SwitchPageAm1({super.key, required this.deviceId});
          ...
          child: Column(
            ...
            children: [
              ...
              Obx(() {
                ...
                if (_mqttController.showSuctionPressure.value) {
                  indicators.add(
                    Expanded(
                      child: _buildIndicatorTile(
                        ...
                        alert:
                            _mqttController.deviceConnections[deviceId] ?? false
                                ? _mqttController.lowpresw.value == "LOW"
                                    ? 'low'.tr
                                    : 'ok'.tr
                                : "--",
                        alertColor: _mqttController.lowpresw.value == 'LOW'
                            ? Colors.red
                            : textColor,
                        isActive: _mqttController.lowpresw.value == 'HIGH',
                        textColor: textColor,
                      ),
                    ),
                  );
                ...
                if (_mqttController.showDischargePressure.value) {
                  indicators.addAll([
                    ...
                    Expanded(
                      child: _buildIndicatorTile(
                        ...
                        alert:
                            _mqttController.deviceConnections[deviceId] ?? false
                                ? _mqttController.highpresw.value == "HIGH"
                                    ? 'high'.tr
                                    : 'ok'.tr
                                : "--",
                        alertColor: _mqttController.highpresw.value == 'HIGH'
                            ? Colors.red
                            : textColor,
                        isActive: _mqttController.highpresw.value == 'HIGH',
                        textColor: textColor,
                      ),
                    ),
                  ]);
                  ...
                  indicators.addAll([
                    ...
                    Expanded(
                      child: _buildIndicatorTile(
                        ...
                        alert:
                            _mqttController.deviceConnections[deviceId] ?? false
                                ? _mqttController.oilpressuream1.value == "LOW"
                                    ? 'low'.tr
                                    : 'ok'.tr
                                : "--",
                        alertColor:
                            _mqttController.oilpressuream1.value == 'LOW'
                                ? Colors.red
                                : textColor,
                        isActive: _mqttController.oilpressuream1.value == 'LOW',
                        textColor: textColor,
                      ),
                    ),
                  ]);
