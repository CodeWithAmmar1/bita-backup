...
import 'package:testappbita/Views/control_master/controlWaterLevel/cm_water_tank.dart';
import 'package:testappbita/controller/water_controller/water_controller.dart';
import 'package:testappbita/utils/theme/theme.dart';

class CMWaterLevelContainer extends StatelessWidget {
  final WaterLevelController controller = Get.put(WaterLevelController());

  CMWaterLevelContainer({super.key});
