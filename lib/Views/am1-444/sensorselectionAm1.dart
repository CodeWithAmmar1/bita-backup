...
class Sensorselectionam1 extends StatefulWidget {
  const Sensorselectionam1({super.key});

  @override
  State<Sensorselectionam1> createState() => _Sensorselectionam1State();
}

Timer? publishTimer;

class _Sensorselectionam1State extends State<Sensorselectionam1> {
          ...
          Row(
            ...
            children: [
              Obx(() {
                ...
                if (index == 0) {
                  selectedValue = _mqttController.selection1Am1.value;
                } else if (index == 1) {
                  selectedValue = _mqttController.selection2Am1.value;
                } else if (index == 2) {
                  selectedValue = _mqttController.selection3Am1.value;
                } else if (index == 3) {
                  selectedValue = _mqttController.selection4Am1.value;
                }
                  ...
                  IconButton(
                      onPressed: () {
                        ...
                        publishTimer = Timer(Duration(seconds: 1), () {
                          _mqttController.buildJsonPayloadAm1444Sensor();
                          publishTimer = Timer(Duration(seconds: 1), () {
    ...
    Get.defaultDialog(
      ...
      content: Obx(() {
        ...
        final List<String> currentSelections = [
          _mqttController.selection1Am1.value,
          _mqttController.selection2Am1.value,
          _mqttController.selection3Am1.value,
          _mqttController.selection4Am1.value,
        ];
        ...
        return Column(
          ...
          children: List.generate(params.length, (optionIndex) {
            ...
            void setSelectionForSensor(int sensor, String value) {
              if (sensor == 0) {
                _mqttController.selection1Am1.value = value;
              } else if (sensor == 1) {
                _mqttController.selection2Am1.value = value;
              } else if (sensor == 2) {
                _mqttController.selection3Am1.value = value;
              } else if (sensor == 3) {
                _mqttController.selection4Am1.value = value;
              }
            }
