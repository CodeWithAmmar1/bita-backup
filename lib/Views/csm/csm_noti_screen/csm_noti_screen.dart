...
class CsmNotiScreen extends StatelessWidget {
  final String deviceid;
  final NotificationControllercsm _notificationController =
      Get.find<NotificationControllercsm>();
  final MqttController _mqttController = Get.find<MqttController>();
  CsmNotiScreen({super.key, required this.deviceid});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            onPressed: () {
              Get.defaultDialog(
                ...
                onConfirm: () {
                  ...
                  _mqttController.clearLastNotifiedValuesCsm(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationController.deviceNotificationMapCsm[deviceid] ?? [];
