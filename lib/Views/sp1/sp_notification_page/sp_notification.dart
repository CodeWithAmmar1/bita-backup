...
class SpNotification extends StatelessWidget {
  ...
  final SpNotificationController _notificationController =
      Get.find<SpNotificationController>();
  final MqttController _mqttController = Get.find<MqttController>();
  SpNotification({super.key, required this.deviceid});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            onPressed: () {
              Get.defaultDialog(
                ...
                onConfirm: () {
                  ...
                  _mqttController.clearLastNotifiedValuesSp1(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationController.deviceNotificationMapSp1[deviceid] ?? [];
