...
class TempHumidity extends StatelessWidget {
  ...
  TempHumidity({super.key, required this.deviceId});
  @override
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Text(
                        'System Temperature & Humidity'.tr,
                        style: TextStyle(
                ...
                children: [
                    ...
                    child: GHSTempWidget(
                      ...
                      temperature:
                          _mqttController.deviceConnections[deviceId] ?? false
                              ? _mqttController.tempGhs.value.toString()
                              : "--",
                      getColorLogic: () =>
                  ...
                  Expanded(
                    child: GHSTempWidget(
                      ...
                      temperature:
                          _mqttController.deviceConnections[deviceId] ?? false
                              ? _mqttController.humidityGhs.value.toString()
                              : "--",
                      getColorLogic: () =>
                          Get.isDarkMode ? Colors.white : Colors.black,
                    ),
...
class GHSTempWidget extends StatelessWidget {
  final String title;
