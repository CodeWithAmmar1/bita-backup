...
class LanguageToggle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() => Container(
          ...
          child: Row(
            ...
            children: [
              _buildToggleButton(
                  'English', langController.isEnglish.value, true, isDarkMode),
              _buildToggleButton(
                  'عربي', !langController.isEnglish.value, false, isDarkMode),
            ],
          ),
        ));
  }
  ...
  Widget _buildToggleButton(
      String text, bool isActive, bool isLeft, bool isDarkMode) {
