...
class NotificationChm extends StatelessWidget {
  ...
  NotificationChm({super.key, required this.deviceid});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              Get.defaultDialog(
                ...
                onConfirm: () {
                  _notificationControllerDm.clearNotifications(deviceid);
                  _mqttController.clearLastNotifiedValuesDm(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationControllerDm.deviceNotificationMapDm[deviceid] ?? [];
            ...
            return Card(
              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    _notificationControllerDm.removeNotification(
                        deviceid, index);
                    _mqttController.clearLastNotifiedValuesDm(deviceid);
                  },
                ),
