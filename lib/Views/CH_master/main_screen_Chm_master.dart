...
class MainScreenChmMaster extends StatefulWidget {
  const MainScreenChmMaster({super.key});
  @override
  State<MainScreenChmMaster> createState() => _MainScreenChmMasterState();
}

late String deviceName;
late String deviceid;

class _MainScreenChmMasterState extends State<MainScreenChmMaster> {
