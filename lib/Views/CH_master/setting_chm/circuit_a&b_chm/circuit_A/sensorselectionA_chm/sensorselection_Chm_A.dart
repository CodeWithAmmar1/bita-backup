...
class SensorselectionChmA extends StatefulWidget {
  const SensorselectionChmA({super.key});

  @override
  State<SensorselectionChmA> createState() => _SensorselectionChmAState();
}

Timer? publishTimer;

class _SensorselectionChmAState extends State<SensorselectionChmA> {
