...
class PressureSelectionChm extends StatefulWidget {
  ...
  @override
  State<PressureSelectionChm> createState() => _PressureselectionState();
}

Timer? publishTimer;

class _PressureselectionState extends State<PressureSelectionChm> {
                  ...
                  child: Row(
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text("${widget.offset.value}",
                            style: TextStyle(
                              fontSize: Get.width * 0.045,
                              fontWeight: FontWeight.bold,
                              color: ThemeColor().actual,
