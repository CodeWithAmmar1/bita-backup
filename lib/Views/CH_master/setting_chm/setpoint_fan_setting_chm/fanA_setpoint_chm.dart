...
class FanaSetpointChm extends StatefulWidget {
  final String title;
  ...
  @override
  State<FanaSetpointChm> createState() => _FanaSetpointChmState();
}

class _FanaSetpointChmState extends State<FanaSetpointChm> {
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    initialValue: widget.initialvalue.value.toDouble().clamp(
                          widget.min.toDouble(),
                          widget.max.toDouble(),
                        ),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      widget.initialvalue.value = value.toInt();
                      _mqttController.updateFanSetpointA(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (widget.initialvalue.value > widget.min) {
                              widget.initialvalue.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateFanSetpointA(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (widget.initialvalue.value < widget.max) {
                              widget.initialvalue.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateFanSetpointA(
