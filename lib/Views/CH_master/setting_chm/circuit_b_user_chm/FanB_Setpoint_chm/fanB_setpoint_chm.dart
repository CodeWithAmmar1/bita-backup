...
class FanbSetpointChm extends StatefulWidget {
  final String title;
  ...
  @override
  State<FanbSetpointChm> createState() => _FanbSetpointChmState();
}

class _FanbSetpointChmState extends State<FanbSetpointChm> {
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    onChange: (value) {
                      ...
                      _mqttController.updateFanSetpointB(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (widget.initialvalue.value > widget.min) {
                              ...
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateFanSetpointB(
