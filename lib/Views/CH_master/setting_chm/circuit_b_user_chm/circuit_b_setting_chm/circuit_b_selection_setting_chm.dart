...
class CircuitBSelectionSettingChm extends StatelessWidget {
  CircuitBSelectionSettingChm({super.key});
          ...
          children: [
            ...
            Obx(
              () => RestartToggleDX(
                ...
                rightText: 'Lag'.tr,
                title: 'Circuit B'.tr,
                value: _mqttController.leadlagBSwitch.value,
                onTap: () async {
                  _mqttController.leadLagBSwLoading.value = true;
                  final newValue = !_mqttController.leadlagBSwitch.value;
                  await _mqttController.leadLagB(newValue);
                  _mqttController.leadLagBSwLoading.value = false;
                  return newValue;
                },
              ),
            ),
            ...
            DxNumberAdj(
              unit: "Sec",
              title: "Start Delay",
              value: _mqttController.dmStartB,
              min: 0,
              max: 600,
            ),
            SizedBox(
            ...
            DXNumberAdjuster(
              unit: "°C",
              title: "Step Size",
              value: _mqttController.dmStepSizeB,
              min: 0.1,
              max: 3.0,
            ),
          ],
