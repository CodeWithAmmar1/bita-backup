...
class SuperheatSetpointRcm extends StatelessWidget {
  SuperheatSetpointRcm({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 100,
                    initialValue: _mqttController.rcSuperSp.value
                        .toDouble()
                        .clamp(0, 100),
                    onChangeStart: (_) {
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.supertemSpRCM(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.rcSuperSp.value.toStringAsFixed(0)}°F",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.rcSuperSp.value > 0) {
                              _mqttController.rcSuperSp.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.supertemSpRCM(_mqttController
                                    .rcSuperSp.value
                                    .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.rcSuperSp.value < 100) {
                              _mqttController.rcSuperSp.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.supertemSpRCM(_mqttController
