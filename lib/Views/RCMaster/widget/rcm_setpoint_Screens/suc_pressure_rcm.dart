...
class SucPressureRcm extends StatelessWidget {
  SucPressureRcm({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 100,
                    initialValue: _mqttController.rcSucpreSp.value
                        .toDouble()
                        .clamp(0, 100),
                    onChangeStart: (_) {
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.sucpreSpRCM(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.rcSucpreSp.value.toStringAsFixed(0)} PSI",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.rcSucpreSp.value > 0) {
                              _mqttController.rcSucpreSp.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.sucpreSpRCM(_mqttController
                                    .rcSucpreSp.value
                                    .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.rcSucpreSp.value < 100) {
                              _mqttController.rcSucpreSp.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.sucpreSpRCM(_mqttController
