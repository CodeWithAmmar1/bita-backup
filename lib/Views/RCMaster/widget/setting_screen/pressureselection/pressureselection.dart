...
class PressureselectionRC extends StatefulWidget {
  ...
  @override
  State<PressureselectionRC> createState() => _PressureselectionRCState();
}

class _PressureselectionRCState extends State<PressureselectionRC> {
            ...
            TextButton(
                onPressed: () {
                  ...
                  if (val < 0 || val > max) {
                    ...
                    log("Valid Input: $val $unitLabel");

                    // Build MQTT message or update UI
                    mqttController.buildJsonPayloadPressureRCM();
                  }
                },
                child: Text(
                  "Submit",
        ...
        children: List.generate(params.length, (i) {
          ...
          return GestureDetector(
            onTap: () {
              ...
              _mqttController.buildJsonPayloadPressureRCM();
              Get.back();
            },
            child: Container(
              width: double.infinity,
