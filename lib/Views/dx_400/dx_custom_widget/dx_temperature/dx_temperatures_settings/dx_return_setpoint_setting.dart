...
class DxReturnSetpointSetting extends StatelessWidget {
  DxReturnSetpointSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 100,
                    initialValue: _mqttController.dxtemp1sethigh.value
                        .toDouble()
                        .clamp(0, 100),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.updatedxChillInlp(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.dxtemp1sethigh.value.toStringAsFixed(0)}°C",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxtemp1sethigh.value > 0) {
                              _mqttController.dxtemp1sethigh.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxChillInlp(_mqttController
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxtemp1sethigh.value < 100) {
                              _mqttController.dxtemp1sethigh.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxChillInlp(_mqttController
