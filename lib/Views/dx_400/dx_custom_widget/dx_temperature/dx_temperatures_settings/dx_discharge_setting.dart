...
class DxDischargeSetting extends StatelessWidget {
  DxDischargeSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 200,
                    initialValue: _mqttController.dxtemp4setlow.value
                        .toDouble()
                        .clamp(0, 200),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      ...
                      _mqttController.updatedxDischargeHigh(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.dxtemp4setlow.value.toStringAsFixed(0)}°C",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxtemp4setlow.value > 0) {
                              _mqttController.dxtemp4setlow.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxDischargeHigh(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxtemp4setlow.value < 200) {
                              _mqttController.dxtemp4setlow.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxDischargeHigh(
