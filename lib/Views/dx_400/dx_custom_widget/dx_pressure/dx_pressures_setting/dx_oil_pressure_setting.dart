...
class DxOilPressureSetting extends StatelessWidget {
  DxOilPressureSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 725,
                    initialValue: _mqttController.dxpsig3sethigh.value
                        .toDouble()
                        .clamp(0, 725),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.updatedxOilPressurelp(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxpsig3sethigh.value > 0) {
                              _mqttController.dxpsig3sethigh.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxOilPressurelp(
                                    _mqttController.dxpsig3sethigh.value
                                        .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxpsig3sethigh.value < 725) {
                              _mqttController.dxpsig3sethigh.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxOilPressurelp(
