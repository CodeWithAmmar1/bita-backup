...
class DxTemperatureselection extends StatefulWidget {
  const DxTemperatureselection({super.key});

  @override
  State<DxTemperatureselection> createState() => _DxTemperatureselectionState();
}

Timer? publishTimer;

class _DxTemperatureselectionState extends State<DxTemperatureselection> {
          ...
          Row(
            ...
            children: [
              ...
              Padding(
                ...
                child: Obx(() {
                  final temps = [
                    _mqttController.dxsensorTemp1.value,
                    _mqttController.dxsensorTemp2.value,
                    _mqttController.dxsensorTemp3.value,
                    _mqttController.dxsensorTemp4.value,
                  ];
          ...
          Row(
            ...
            children: [
              Obx(() {
                ...
                if (index == 0) {
                  selectedValue = _mqttController.dxselection1.value;
                } else if (index == 1) {
                  selectedValue = _mqttController.dxselection2.value;
                } else if (index == 2) {
                  selectedValue = _mqttController.dxselection3.value;
                } else if (index == 3) {
                  selectedValue = _mqttController.dxselection4.value;
                }
                ...
                children: [
                  ...
                  IconButton(
                      onPressed: () {
                        ...
                        ctrl.dXchangeOffset(index, -1);
                        publishTimer?.cancel();
                        publishTimer = Timer(Duration(seconds: 1), () {
                          _mqttController.dxbuildJsonPayloadSensor();
                          publishTimer = Timer(Duration(seconds: 1), () {
                  ...
                  Obx(() {
                    final offsets = [
                      int.tryParse(_mqttController.dxoffsett1.value) ?? 0,
                      int.tryParse(_mqttController.dxoffsett2.value) ?? 0,
                      int.tryParse(_mqttController.dxoffsett3.value) ?? 0,
                      int.tryParse(_mqttController.dxoffsett4.value) ?? 0,
                    ];
    ...
    Get.defaultDialog(
      ...
      content: Obx(() {
        ...
        final List<String> currentSelections = [
          _mqttController.dxselection1.value,
          _mqttController.dxselection2.value,
          _mqttController.dxselection3.value,
          _mqttController.dxselection4.value,
        ];
        ...
        return Column(
          ...
          children: List.generate(params.length, (optionIndex) {
            ...
            void setSelectionForSensor(int sensor, String value) {
              if (sensor == 0) {
                _mqttController.dxselection1.value = value;
              } else if (sensor == 1) {
                _mqttController.dxselection2.value = value;
              } else if (sensor == 2) {
                _mqttController.dxselection3.value = value;
              } else if (sensor == 3) {
                _mqttController.dxselection4.value = value;
              }
            }
