...
class DxAmpereSetting extends StatelessWidget {
  DxAmpereSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 100,
                    initialValue: _mqttController.dxamp1low.value
                        .toDouble()
                        .clamp(0, 100),
                    onChangeStart: (_) =>
                    ...
                    onChange: (double value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.updatedxPhase1hp(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              _mqttController.dxamp1low.value
                                  .toDouble()
                                  .toStringAsFixed(0),
                              style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxamp1low.value > 0) {
                              _mqttController.dxamp1low.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxPhase1hp(
                                    _mqttController.dxamp1low.value.toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.dxamp1low.value < 100) {
                              _mqttController.dxamp1low.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatedxPhase1hp(
