...
import 'package:testappbita/Views/dx_400/dx_custom_widget/dx_amperes/dx_ampere_settings/dx_ampere_setting.dart';
import 'package:testappbita/controller/mqtt_controller/mqtt_controller.dart';
import 'package:testappbita/utils/theme/theme.dart';

class DxAmpereContainer extends StatelessWidget {
  final String deviceId;
  final MqttController _mqttController = Get.find<MqttController>();

  DxAmpereContainer({super.key, required this.deviceId});
                          ...
                          child: AmpereWidget(
                              ...
                              ampere:
                                  _mqttController.deviceConnections[deviceId] ??
                                          false
                                      ? _mqttController.dxamp2.value.toString()
                                      : "--")),
                      SizedBox(width: Get.width * 0.015),
                      Expanded(
                          child: AmpereWidget(
                              ...
                              ampere:
                                  _mqttController.deviceConnections[deviceId] ??
                                          false
                                      ? _mqttController.dxamp3.value.toString()
                                      : "--")),
                      SizedBox(width: Get.width * 0.015),
                      Expanded(
                          child: AmpereWidget(
                              ...
                              ampere:
                                  _mqttController.deviceConnections[deviceId] ??
                                          false
                                      ? _mqttController.dxamp1.value.toString()
                                      : "--")),
                    ],
                  )),
      ...
      child: Column(
        ...
        children: [
          ...
          Obx(() {
            ...
            final int lowLimit = _mqttController.dxamp1low.value;
