        ...
        children: [
          ...
          Obx(
              () => RestartToggle(
                ...
                value: _mqttController.isModeSwitch.value,
                onTap: () async {
                  _mqttController.modeSwLoading.value = true;
                  final newValue = !_mqttController.isModeSwitch.value;
                  await _mqttController.modeSwitch(newValue);
                  _mqttController.modeSwLoading.value = false;
                  return newValue;
                },
              ),
          ),
