...
class Pressureselection extends StatefulWidget {
  final String title;
  ...
  @override
  State<Pressureselection> createState() => _PressureselectionState();
}

class _PressureselectionState extends State<Pressureselection> {
            ...
            TextButton(
                onPressed: () {
                  ...
                  if (val < 0 || val > max) {
                    ...
                    mqttController.buildJsonPayloadPressure();
                  }
                },
                child: Text(
                  "Submit",
