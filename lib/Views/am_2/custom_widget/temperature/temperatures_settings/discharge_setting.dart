        ...
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: TextStyle(
              ...
              fontSize: getResponsiveFontSize(screenWidth, 0.06), // responsive
            ),
          ),
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: _mqttController.ftoC.value ? 200 : 392,
                    initialValue: _mqttController.temp4setlow.value
                        .toDouble()
                        .clamp(0, _mqttController.ftoC.value ? 200 : 392),
                    onChangeStart: (_) =>
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.temp4setlow.value.toStringAsFixed(0)}${_mqttController.ftoC.value ? "°C" : "°F"}",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.temp4setlow.value > 0) {
                              _mqttController.temp4setlow.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateDischargeHigh(
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.temp4setlow.value <
                                (_mqttController.ftoC.value ? 200 : 392)) {
                              _mqttController.temp4setlow.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateDischargeHigh(
