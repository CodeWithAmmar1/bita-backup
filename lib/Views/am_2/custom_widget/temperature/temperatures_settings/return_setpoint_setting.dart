...
class ReturnSetPointSetting extends StatelessWidget {
  ReturnSetPointSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    initialValue:
                        _mqttController.temp1sethigh.value.toDouble().clamp(
                              0,
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.temp1sethigh.value.toStringAsFixed(0)}${_mqttController.ftoC.value ? "°C" : "°F"}",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.temp1sethigh.value > 0) {
                              _mqttController.temp1sethigh.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateChillInlp(_mqttController
                                    .temp1sethigh.value
                                    .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.temp1sethigh.value <
                                (_mqttController.ftoC.value ? 100 : 212)) {
                              _mqttController.temp1sethigh.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
