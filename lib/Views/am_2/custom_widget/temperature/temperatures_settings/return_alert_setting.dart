...
class ReturnAlertSetting extends StatelessWidget {
  ReturnAlertSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: _mqttController.ftoC.value ? 100 : 212,
                    initialValue:
                        _mqttController.temp1setlow.value.toDouble().clamp(
                              0,
                              _mqttController.ftoC.value ? 100 : 212,
                            ),
                    onChangeStart: (_) {
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.updateChillInhp(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.temp1setlow.value.toStringAsFixed(0)}${_mqttController.ftoC.value ? "°C" : "°F"}",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.temp1setlow.value > 0) {
                              _mqttController.temp1setlow.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateChillInhp(_mqttController
                                    .temp1setlow.value
                                    .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.temp1setlow.value <
                                (_mqttController.ftoC.value ? 100 : 212)) {
                              _mqttController.temp1setlow.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
