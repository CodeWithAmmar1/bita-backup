              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: _mqttController.psiTobar.value ? 725 : 50,
                    initialValue: _mqttController.psig3sethigh.value
                        .toDouble()
                        .clamp(0, _mqttController.psiTobar.value ? 725 : 50,),
                    onChangeStart: (_) =>
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                             _mqttController.psiTobar.value ?"PSI" : "Bar",
                              style: TextStyle(
                                fontFamily: 'DS-Digital',
                                fontSize:
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.psig3sethigh.value > 0) {
                              _mqttController.psig3sethigh.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateOilPressurelp(
                                    _mqttController.psig3sethigh.value
                                        .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.psig3sethigh.value < (_mqttController.psiTobar.value ? 725 : 50)) {
                              _mqttController.psig3sethigh.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updateOilPressurelp(
