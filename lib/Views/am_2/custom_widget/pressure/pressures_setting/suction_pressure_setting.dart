              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max:  _mqttController.psiTobar.value ? 300 : 21,
                    initialValue: _mqttController.psig1sethigh.value
                        .toDouble()
                        .clamp(0, _mqttController.psiTobar.value ? 300 : 21),
                    onChangeStart: (_) =>
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.psig1sethigh.value > 0) {
                              _mqttController.psig1sethigh.value -= 1;
                              publishTimer?.cancel();
                              _mqttController.updateLowPressurelp(
                                  _mqttController.psig1sethigh.value
                                      .toDouble());
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.buildJsonPayload();
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.psig1sethigh.value < (_mqttController.psiTobar.value ? 300 : 21)) {
                              _mqttController.psig1sethigh.value += 1;
                              publishTimer?.cancel();
                              _mqttController.updateLowPressurelp(
                                  _mqttController.psig1sethigh.value
