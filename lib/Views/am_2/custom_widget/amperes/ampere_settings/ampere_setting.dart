              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    max: 100,
                    initialValue:
                        _mqttController.amp1low.value.toDouble().clamp(0, 100),
                    onChangeStart: (_) =>
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.amp1low.value > 0) {
                              _mqttController.amp1low.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatePhase1hp(
                                    _mqttController.amp1low.value.toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.amp1low.value < 100) {
                              _mqttController.amp1low.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.updatePhase1hp(
