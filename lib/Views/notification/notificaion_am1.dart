...
class NotificationPageAM1 extends StatelessWidget {
  final String deviceid;
  final NotificationControlleraM1 _notificationController =
      Get.find<NotificationControlleraM1>();
  final MqttController _mqttController = Get.find<MqttController>();
  NotificationPageAM1({super.key, required this.deviceid});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            onPressed: () {
              Get.defaultDialog(
                ...
                onConfirm: () {
                  ...
                  _mqttController.clearLastNotifiedValues(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationController.deviceNotificationMapAm1[deviceid] ?? [];
              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    ...
                    _mqttController.clearLastNotifiedValuesAm1(deviceid);
                  },
                ),
              ),
            );
