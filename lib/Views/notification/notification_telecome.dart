...
class NotificationTelecome extends StatelessWidget {
  final String deviceid;
  final TelecomNotificationController _notificationController =
      Get.find<TelecomNotificationController>();
  final MqttController _mqttController = Get.find<MqttController>();
  NotificationTelecome({super.key, required this.deviceid});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          IconButton(
            ...
            onPressed: () {
              Get.defaultDialog(
                ...
                onConfirm: () {
                  _notificationController.clearNotificationsTel(deviceid);
                  _mqttController.clearLastNotifiedValuesTel(deviceid);
                  Get.back();
                },
              );
            },
      ...
      body: Obx(() {
        final history =
            _notificationController.deviceNotificationMapTel[deviceid] ?? [];
            ...
            return Card(
              ...
              child: ListTile(
                ...
                trailing: IconButton(
                  ...
                  onPressed: () {
                    _notificationController.removeNotificationTel(
                        deviceid, index);
                    _mqttController.clearLastNotifiedValuesTel(deviceid);
                  },
                ),
