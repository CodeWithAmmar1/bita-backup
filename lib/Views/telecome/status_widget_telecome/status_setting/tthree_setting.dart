...
class TthreeSetting extends StatelessWidget {
  TthreeSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 100,
                    initialValue: _mqttController.tThreeTel.value
                        .toDouble()
                        .clamp(0, 100),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.tempThreeSetpoint(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Column(
                            ...
                            children: [
                              Text(
                                _mqttController.tThreeTel.value
                                    .toStringAsFixed(0),
                                style: TextStyle(
                    ...
                    child: Row(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            _mqttController.isUserInteracting.value = true;
                            if (_mqttController.tThreeTel.value > 0) {
                              _mqttController.tThreeTel.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.tempThreeSetpoint(
                                    _mqttController.tThreeTel.value.toDouble());
                                _mqttController.isUserInteracting.value = false;
                              });
                            }
                          },
                        ...
                        ElevatedButton(
                          onPressed: () {
                            _mqttController.isUserInteracting.value = true;
                            if (_mqttController.tThreeTel.value < 100) {
                              _mqttController.tThreeTel.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.tempThreeSetpoint(
