...
class ToneSetting extends StatelessWidget {
  ToneSetting({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    max: 12,
                    initialValue:
                        _mqttController.tOneTel.value.toDouble().clamp(0, 12),
                    onChangeStart: (_) {
                      _mqttController.isUserInteracting.value = true;
                    },
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.tempOneSetpoint(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tOneTel.value > 0) {
                              _mqttController.tOneTel.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.tempOneSetpoint(
                                    _mqttController.tOneTel.value.toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tOneTel.value < 12) {
                              _mqttController.tOneTel.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.tempOneSetpoint(
