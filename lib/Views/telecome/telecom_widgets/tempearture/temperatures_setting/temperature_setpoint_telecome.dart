...
class TemperatureSetpointTelecome extends StatelessWidget {
  TemperatureSetpointTelecome({super.key});
              ...
              () => Column(
                ...
                children: [
                  ...
                  SleekCircularSlider(
                    ...
                    min: 0,
                    max: 30,
                    initialValue: _mqttController.tempSetPointTel.value
                        .toDouble()
                        .clamp(0, 30),
                    onChangeStart: (_) =>
                    ...
                    onChange: (value) {
                      _mqttController.isUserInteracting.value = true;
                      _mqttController.tempSetpoint(value);
                    },
                    onChangeEnd: (_) {
                      publishTimer?.cancel();
                      publishTimer = Timer(Duration(seconds: 1), () {
                        _mqttController.buildJsonPayloadTel();
                        publishTimer = Timer(Duration(seconds: 1), () {
                    ...
                    innerWidget: (_) => Center(
                      child: Container(
                        ...
                        child: Center(
                          child: Text(
                            "${_mqttController.tempSetPointTel.value.toStringAsFixed(0)}°C",
                            style: TextStyle(
                      ...
                      children: [
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tempSetPointTel.value > 0) {
                              _mqttController.tempSetPointTel.value -= 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.tempSetpoint(_mqttController
                                    .tempSetPointTel.value
                                    .toDouble());
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            if (_mqttController.tempSetPointTel.value < 30) {
                              _mqttController.tempSetPointTel.value += 1;
                              publishTimer?.cancel();
                              publishTimer = Timer(Duration(seconds: 1), () {
                                _mqttController.tempSetpoint(_mqttController
