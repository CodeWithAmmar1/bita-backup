...
class Am2444card extends StatelessWidget {
  final DeviceModel device;
  Am2444card({super.key, required this.device});
    ...
    return Obx(
      () => Card(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              Get.to(() => Dashboardam2(isFromDevicePage: true,), arguments: {
                "name": "${device.deviceName}",
                "id": "${device.deviceId}",
                "type": "AM1-444-${"control_system".tr}",
                "type2": "AM1-444-${"monitoring_system".tr}"
              });
                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.blue.shade100, // Light blue shade
