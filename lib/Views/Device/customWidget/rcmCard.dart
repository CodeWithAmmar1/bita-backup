...
import 'package:testappbita/Views/RCMaster/rcm_main_screen.dart';
...
class Rcmastercard extends StatelessWidget {
  final DeviceModel device;
  Rcmastercard({super.key, required this.device});
    ...
    return Obx(
      () => Card(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              Get.to(() => RcmMainScreen(), arguments: {
