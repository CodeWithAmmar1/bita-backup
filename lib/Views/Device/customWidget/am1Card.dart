...
class Am1card extends StatelessWidget {
  final DeviceModel device;
  Am1card({super.key, required this.device});
    ...
    return Obx(
      () => Card(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              Get.to(() => Dashboardam1(isFromDevicePage: false,), arguments: {
                "name": "${device.deviceName}",
                "id": "${device.deviceId}",
                "type": "AM1B-${"control_system".tr}",
                "type2": "AM1B-${"monitoring_system".tr}"
              });
