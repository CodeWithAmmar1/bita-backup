...
import 'package:testappbita/Views/water_tank_control/water_tank_wtc/wtc_mainScreen.dart';
...
class Wtccard extends StatelessWidget {
  final DeviceModel device;
  Wtccard({super.key, required this.device});
    ...
    return Obx(
      () => Card(
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              Get.to(() => WtcMainscreen(), arguments: {
