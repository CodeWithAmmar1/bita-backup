...
import 'package:testappbita/Views/drain_master/drain_homepage.dart';
...
class Seweragecard extends StatelessWidget {
  final DeviceModel device;
  Seweragecard({super.key, required this.device});
