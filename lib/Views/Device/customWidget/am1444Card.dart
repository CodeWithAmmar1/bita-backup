...
class Am1444card extends StatelessWidget {
  final String id;
  final DeviceModel device;
  Am1444card({super.key, required this.device, required this.id});
        ...
        child: Container(
          ...
          child: InkWell(
            onTap: () {
              Get.to(
                  () => Dashboardam1(
                        isFromDevicePage: true,
                      ),
                  arguments: {
                    "name": "${device.deviceName}",
                    "id": "${device.deviceId}",
                    "type": "AM1-$id-${"control_system".tr}",
                    "type2": "AM1-$id-${"monitoring_system".tr}"
                  });
