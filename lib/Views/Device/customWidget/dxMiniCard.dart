...
import 'package:testappbita/Views/dx_mini/dx_mini_screen.dart';
...
class Dxminicard extends StatelessWidget {
  final DeviceModel device;
  Dxminicard({super.key, required this.device});
